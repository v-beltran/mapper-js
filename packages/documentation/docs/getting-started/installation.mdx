...
```shell
npm i automapper-core automapper-nestj automapper-classes reflect-metadata # for classes
npm i automapper-core automapper-nestj automapper-classes reflect-metadata automapper-mikro # for classes + mikro-orm
npm i automapper-core automapper-nestj automapper-classes reflect-metadata automapper-sequelize # for classes + sequelize
npm i automapper-core automapper-nestj automapper-pojos # for pojos
```

```shell
yarn add automapper-core automapper-nestj automapper-classes reflect-metadata # for classes
yarn add automapper-core automapper-nestj automapper-classes reflect-metadata automapper-mikro # for classes + mikro-orm
yarn add automapper-core automapper-nestj automapper-classes reflect-metadata automapper-sequelize # for classes + sequelize
yarn add automapper-core automapper-nestj automapper-pojos # for pojos
```
